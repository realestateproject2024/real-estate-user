  ...
  return (
    <LayoutOne topbar={true}>
                          ...
                          <Col xs={12} lg={6} className="align-self-center">
                            <div className="about-us-info-wrap">
                              ...
                              <p>
                                ...
                                adipis icing elit, sed do eius mod t
                              </p>
                            </div>
                          </Col>
                        </Row>
      ...
      <div
        ...
        style={{ backgroundImage: `url("../img/bg/13.jpg")` }}
      >
        <Container>
          <Row>
            <Col xs={12}>
              <div className="call-to-action-inner call-to-action-inner-5 text-decoration text-center">
                <h2 className="white-color">
                  ...
                  <Link href="https://quarter-nextjs.netlify.app/team/kelian-anderson">
                    An Appointment
                  </Link>
                </h2>
              </div>
