            ...
            <Row>
              <Col xs={12} sm={6} xl={4}>
                <div className="footer-widget footer-about-widget">
                  ...
                  <p>
                    Leaders in real estate financing brokerage, we specialize in
                    tailoring solutions for your property ventures. Trust us to
                  ...
                  <div className="footer-address">
                    <ul>
                      ...
                      <li>
                        ...
                        <div className="footer-address-info">
                          <p>
                            <Link href="tel:+0123-456789">0547724276</Link>
                          </p>
                        </div>
                      </li>
                      <li>
